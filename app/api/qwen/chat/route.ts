...
export async function POST(req:Request){try{
 ...
 const context={...snapshot.data,messages:undefined,history:undefined,appliedIds:undefined,pendingProposals:pending.map(d=>({summary:d.summary,operations:d.operations,stale:d.workRevision!==snapshot.data.workRevision}))};
